...
### 🎐 活着的她
- 完整立绘(可选 3 套姿势)在水下光斑、深海泡泡与呼吸动画中缓缓浮动
- 11 种休闲小动作:伸懒腰、转圈圈、打瞌睡、蹦蹦跳、左右张望、冒泡泡、跳舞、打喷嚏、挥手、歪头杀、抖尾巴、害羞捂脸
- 心情表情:开心 ♪ / 亲亲 💗 / 困困 💤 / 闹别扭 💢 / 吃到鱼干 ✨
- 会在屏幕工作区内自由漫游,被你拖走就乖乖待着

### 💬 聊天与任务
- **双击/长按/右键菜单** 打开聊天室:纯本地 WPF 窗口,与鲸鱼娘会话实时对话
- **🛠️ 工作台**:下达任务,实时查看她的工作流(工具调用、结果、汇报)
- **🔐 审批直达聊天室**:她要权限时在聊天室弹出提示,回复「同意」即可放行,不用碰浏览器
- **📋 工作简报**:任务完成推送简报(用了哪些工具)
- **🛠️ 实时进度**:干活时聊天室滚动显示每一步工具调用
